...
#                             ),
                          ...
                          absolutePanel(id = "controls", class="modal", fixed=TRUE, draggable=TRUE, top=120, left=300, right="auto", bottom="auto", width=200, height="auto",
                                        h4("Capas espaciales"),
                                        tags$hr(),
                                        checkboxGroupInput('capas', label = "", choices = c('Isóbatas'='isobatas', 'Estaciones de mejillón'='est_mej','Pecios'='pecios','Densidad AIS - Fondeos (2012-2013)'='dens_ais','Navegación sonar'='nav_son')
                                                           )
                                        )
                          ),
